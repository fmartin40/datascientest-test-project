...
class Mappings(IMappings):
    async def list_type_contrat(self) -> dict:
        try:
            mapping_dict = {
                mapping.libelle: mapping.type_contrat.id if mapping.type_contrat else None
    ...
    async def list_mode_travail(self) -> dict:
        try:
            mapping_dict = {
                mapping.libelle: mapping.mode_travail.id if mapping.mode_travail else None
    ...
    async def list_duree_travail(self) -> dict:
        try:
            mapping_dict = {
                mapping.libelle: mapping.duree_travail.id if mapping.duree_travail else None
    ...
    async def list_competence(self) -> dict:
        try:
            mapping_dict = {
                mapping.libelle: mapping.competence.id if mapping.competence else None
